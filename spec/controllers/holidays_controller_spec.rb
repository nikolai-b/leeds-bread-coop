...
describe HolidaysController do
  ...
  let(:valid_attributes) { { "start_date" => "2014-07-01" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved holiday as @holiday" do
        ...
        post :create, {:holiday => { "start_date" => "invalid value" }}, valid_session
        assigns(:holiday).should be_a_new(Holiday)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested holiday" do
        ...
        Holiday.any_instance.should_receive(:update).with({ "start_date" => "2014-07-01" })
        put :update, {:id => holiday.to_param, :holiday => { "start_date" => "2014-07-01" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the holiday as @holiday" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Holiday.any_instance.stub(:save).and_return(false)
        put :update, {:id => holiday.to_param, :holiday => { "start_date" => "invalid value" }}, valid_session
        assigns(:holiday).should eq(holiday)
      end
